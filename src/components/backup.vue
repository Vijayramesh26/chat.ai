          ...
          <div v-else class="messages-list">
            <div v-for="message in messages" :key="message.id" class="message-item">
              ...
              <div v-if="message.type === 'user'" class="d-flex justify-end">
                <div class="message-bubble primary white--text" :style="{ maxWidth: $vuetify.breakpoint.mobile ? '100%' : '70%' }">
                  {{ message.content }}
                </div>
              </div>
              ...
              <div v-if="message.type === 'ai'" class="d-flex justify-start flex-column "> 
                <div class="message-bubble  grey--text text--lighten-4 overflow-x-auto" 
                ...
                <div class="d-flex align-end justify-left">
                  <v-btn small  outlined @click="copyText(message.content)">
                    <v-icon small color="white" class=" ">mdi-content-copy</v-icon>
                  </v-btn>
                </div>
              </div> 
            </div>
            ...
            <div v-if="isLoading" class="d-flex justify-start">
              <div class="message-bubble  ">
                <div class="d-flex align-center">
                  ...
                  <span class="grey--text text--lighten-4">Thinking...</span>
                </div>
              </div>
            </div>
          </div>
